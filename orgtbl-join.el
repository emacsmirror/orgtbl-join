...
(defun orgtbl-join--replace-table (params table)
  ...
  (let ((content (plist-get params :content))
    ...
    (when content
      ...
      (if (string-match
        ...
        (insert content)))
    (orgtbl-join--insert-elisp-table table)
    (orgtbl-join--table-recalculate content (plist-get params :formula))
    (insert after)))

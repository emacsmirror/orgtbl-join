...
(defun orgtbl-join-wizard-test (keep &rest args)
  (forward-line 1)
  (unless keep
    (org-mark-element)
...
* Recreate join with expert wizard

#+begin_src elisp :results none
(orgtbl-join-wizard-test nil
 :init    "C-u C-c C-x x jo <tab> <return>"
 :isid    "n"
 :file    "<return>"
 :name    "land <tab> <return>"
 :params  "<return>"
 :slice   "<return>"
 :isid    "n"
...
#+begin_src elisp :results none
(orgtbl-join-wizard-test t
 :init    "C-u C-c C-x x joi <tab> <return>"
 :file    "<return>"
 :name    "<return>"
 :params  "<return>"
 :slice   "<return>"
...
Add a computed column with onces (converted from grams)
...
#+BEGIN: join :mas-table "unittests.org:meal_with_header" :ref-table "unittests.org:nut_with_header" :mas-column "product" :ref-column "type" :full "mas"
#+name: fadenado
#+caption: estas fadenita
| product   |   quty | Carb | Fiber | Sugar | Protein |      |
| common    |     in | ohyd |       |       |         |      |
| name      | gramms | rate |       |       |         |      |
| (english) |        |      |       |       |         |      |
|-----------+--------+------+-------+-------+---------+------|
| onion     |     70 |  9.0 |   1.3 |   4.4 |     1.3 |  2.5 |
| unknown   |    999 |      |       |       |         | 35.2 |
| tomatoe   |    120 |  3.4 |   0.6 |   2.1 |     0.8 |  4.2 |
| eggplant  |    300 |  8.6 |   2.5 |   3.2 |     0.8 | 10.6 |
| eggplant  |    300 |  8.7 |   2.6 |   3.3 |     0.9 | 10.6 |
| eggplant  |    300 |  8.5 |     ? |     ? |       ? | 10.6 |
| corn      |    250 | 21.3 |   4.7 |   1.8 |     2.8 |  8.8 |
#+TBLFM: $7=$2*0.03527396;f1
#+END:
